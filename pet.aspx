...
<body>
   <iframe src="header.aspx" scrolling="no" style="border:none; width:100%; height:470px;"></iframe>
    ...
    <div class="gallery" runat="server" id="pet1">
     ...
     <asp:Button ID="Button1" Text="Want to Sell Your Pet...?" runat="server" OnClick="sellpet" />
    <asp:Button ID="login" Text="Please Sign Up/Login to buy pets..." runat="server" OnClick="checkforlogin" /></form>
